...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/tmp/steward/.claude/.gsd-surface.json`
(sibling to `/tmp/steward/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/tmp/steward/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/tmp/steward/.claude/skills`).
...
`/tmp/steward/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/tmp/steward/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/tmp/steward/.claude/.gsd-surface.json`
Install profile marker: `/tmp/steward/.claude/.gsd-profile`
Skill dirs: `/tmp/steward/.claude/skills/gsd-*/`
Engine module: `/tmp/steward/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/tmp/steward/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
