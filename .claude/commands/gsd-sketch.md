...
<execution_context>
@/tmp/steward/.claude/gsd-core/workflows/sketch.md
@/tmp/steward/.claude/gsd-core/workflows/sketch-wrap-up.md
@/tmp/steward/.claude/gsd-core/references/ui-brand.md
@/tmp/steward/.claude/gsd-core/references/sketch-theme-system.md
@/tmp/steward/.claude/gsd-core/references/sketch-interactivity.md
@/tmp/steward/.claude/gsd-core/references/sketch-tooling.md
@/tmp/steward/.claude/gsd-core/references/sketch-variant-patterns.md
</execution_context>
