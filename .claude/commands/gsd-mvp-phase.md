...
<execution_context>
@/tmp/steward/.claude/gsd-core/workflows/mvp-phase.md
@/tmp/steward/.claude/gsd-core/references/spidr-splitting.md
@/tmp/steward/.claude/gsd-core/references/user-story-template.md
</execution_context>
...
<process>
Execute the mvp-phase workflow from @/tmp/steward/.claude/gsd-core/workflows/mvp-phase.md end-to-end.
