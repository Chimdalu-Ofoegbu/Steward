...
<execution_context>
@/tmp/steward/.claude/gsd-core/workflows/update.md
</execution_context>
...
@/tmp/steward/.claude/gsd-core/workflows/sync-skills.md
@/tmp/steward/.claude/gsd-core/workflows/reapply-patches.md
</execution_context_extended>
