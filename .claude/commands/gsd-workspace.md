...
<execution_context>
@/tmp/steward/.claude/gsd-core/workflows/new-workspace.md
@/tmp/steward/.claude/gsd-core/workflows/list-workspaces.md
@/tmp/steward/.claude/gsd-core/workflows/remove-workspace.md
