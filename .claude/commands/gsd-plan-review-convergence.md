...
<execution_context>
@/tmp/steward/.claude/gsd-core/workflows/plan-review-convergence.md
@/tmp/steward/.claude/gsd-core/references/revision-loop.md
@/tmp/steward/.claude/gsd-core/references/gates.md
@/tmp/steward/.claude/gsd-core/references/agent-contracts.md
</execution_context>
