...
<execution_context>
@/tmp/steward/.claude/gsd-core/workflows/settings.md
@/tmp/steward/.claude/gsd-core/workflows/settings-advanced.md
@/tmp/steward/.claude/gsd-core/workflows/settings-integrations.md
</execution_context>
