...
<required_reading>
@/tmp/steward/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/tmp/steward/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /tmp/steward/.claude
                  → checks /tmp/steward/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /tmp/steward/.claude/gsd-core
                  → writes to /tmp/steward/.claude/gsd-core/hooks/
...
@/tmp/steward/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/tmp/steward/.claude/gsd-core/references/common-bug-patterns.md
