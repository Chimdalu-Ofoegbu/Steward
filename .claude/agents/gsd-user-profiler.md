...
<reference>
@/tmp/steward/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/tmp/steward/.claude/gsd-core/references/user-profiling.md` to load:
